...
?>
                        ...
                        <tr>
   					  ...
   					  <tbody>
							...
							while($mode=$res->fetchObject()){
								echo '<tr id="tr'.$mode->id_daoura.'">';
								echo "<td>";
								echo $mode->desc_daoura;
								echo "</td>";
								echo "<td>";
								echo $mode->description_daoura	;
								echo "</td>";
								...
								echo "<td>";
								echo "<button id='$mode->id_daoura'class='btn btn-default editM' data-toggle='modal' data-target='#editModal'><span class='glyphicon glyphicon-edit' style='color:green;'></span></button>";
								echo "</td>";
								echo "<td>";
								echo '<button class="btn btn-default deleteM"  name="removeBTN" onclick="deliting('.$mode->id_daoura.')"><span class="glyphicon glyphicon-remove " style="color:red"></span></button>';
    ...
    <?php
	require_once "includes/footer_daoura.php";
	?>