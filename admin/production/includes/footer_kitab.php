  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal" id="formA" action="actions/kitab.php" method="post" enctype="multipart/form-data">
		  <div class="form-group">
			<label for="titre" class="col-sm-2 control-label">Sujet</label>
			<div class="col-sm-10">
			  <select type="text" class="form-control" id="titre" name="titre" required="required">
				<?php
					$sql="select * from type_sujet";
					$res=$connect->query($sql);
					while($r=$res->fetchObject()){
						echo '<option value='.$r->id_sujet.'>'.$r->desc_sujet.'</option>';
		   ...
		   <div class="form-group">
			<label for="pays" class="col-sm-2 control-label" required="required" id="paysDiv">Desc</label>
			<div class="col-sm-10">
					<textarea class="form-control" name="description"></textarea>
			</div>
		  </div>
		  <div class="form-group">
			<label for="pays" class="col-sm-2 control-label" required="required" id="paysDiv">detail</label>
			<div class="col-sm-10">
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal" id="formA" action="actions/kitab.php" method="post" enctype="multipart/form-data">
		...
		<select type="text" class="form-control" id="Utitre" name="titre" required="required">
				<?php
					$sql="select * from type_sujet";
					$res=$connect->query($sql);
					while($r=$res->fetchObject()){
    ...
    <script src="../build/js/custom.min.js"></script>
	    <script src="assest/js/kitab.js"></script>
