  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form class="form-horizontal" id="formA" action="actions/profs.php" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
			<label for="article" class="col-sm-2 control-label">Prenom</label>
			<div class="col-sm-10">
				<input type="text" class="form-control" id="daoura" name="daoura" required="required"/>
...
<div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" style="">
  <div class="modal-dialog" role="document">
      ...
      <div class="modal-body">
       <form class="form-horizontal" id="formA" action="actions/profs.php" method="post" enctype="multipart/form-data">
		  ...
		  <div class="form-group">
			...
			<div class="col-sm-10">
			<input type="text" class="form-control" id="Udaoura" name="daoura" required="required"/>
    ...
    <script src="../build/js/custom.min.js"></script>
	    <script src="assest/js/prof.js"></script>
