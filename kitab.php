...
$sqltitre="select desc_kitab from kitab where id_k='$id_titre'";
$titre_kitab = $conn->query($sqltitre);
$titreK = $titre_kitab->fetch_array(MYSQLI_ASSOC);
$kitab = $titreK['desc_kitab'];
/*$_session['admin']=true;*/
$messagesParPage=3; //Nous allons afficher 3 messages par page.
 
//Une connexion SQL doit être ouverte avant cette ligne...
$sql2="SELECT COUNT(*) AS total from cour c,kitab k where c.id_kitab='$id_titre' and c.id_kitab=k.id_k "; //Nous récupérons le contenu de la requête dans $retour_total
...
$sql3="SELECT * from cour c,cour_prof l,professeur p,kitab k where c.id_cour=l.id_cour_r and p.id_prof=l.id_prof_r and k.id_k='$id_titre' and k.id_k=c.id_kitab order by c.date_cour desc LIMIT $premiereEntree,$messagesParPage"; //Nous récupérons le contenu de la requête dans $retour_total
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <?php    
            ...
            for($i=1; $i<=$nombreDePages; $i++) //On fait notre boucle
            {
                 ...
                 {
                      echo ' <a href="kitab.php?page='.$i.'&t='.$id_titre.'">'.$i.'</a> ';
                 }
            }
            echo '</p>';
    ?>
