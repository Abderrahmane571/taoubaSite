...
$sql2="SELECT COUNT(id_daoura) AS total FROM daoura";
...
$sql3="SELECT * FROM daoura LIMIT $premiereEntree,$messagesParPage";
...
/*select * from cour c,cour_prof l,professeur p where c.type='1' and c.id_cour=l.id_cour_r and p.id_prof=l.id_prof_r order by c.date_cour desc";*/
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
                   ...
                   <div class="card1">
  						<div class="container1">
  							<div class="infobank1" style="font-family: kof">
                               <?php $t="daoura.php?t=".$donnees_messages['id_daoura'];?>
	  						
	  							<br><br><B>عنوان الدورة: <?php echo $donnees_messages['desc_daoura'];?> </B><br><B>مختصر عن الدورة: <?php echo $donnees_messages['description_daoura'];?></B> <br><br> <a style="font-family: kof" href="<?php echo $t;?>"><p align="left"><B>مشاهدة</B></p></a>
 							</div>
 						</div>
 					</div>
 				</div>
    ...
    <?php    
            ...
            for($i=1; $i<=$nombreDePages; $i++) //On fait notre boucle
            {
                 ...
                 {
                      echo ' <a href="daouarat.php?page='.$i.'">'.$i.'</a> ';
                 }
            }
            echo '</p>';
    ?>
