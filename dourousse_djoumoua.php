...
$sql2="SELECT COUNT(*) AS total from cour c,cour_prof l,professeur p where c.type='1' and c.id_cour=l.id_cour_r and p.id_prof=l.id_prof_r order by c.date_cour desc"; //Nous récupérons le contenu de la requête dans $retour_total
...
$sql3="SELECT * from cour c,cour_prof l,professeur p where c.type='1' and c.id_cour=l.id_cour_r and p.id_prof=l.id_prof_r order by c.date_cour desc LIMIT $premiereEntree,$messagesParPage"; //Nous récupérons le contenu de la requête dans $retour_total
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <?php    
            ...
            for($i=1; $i<=$nombreDePages; $i++) //On fait notre boucle
            {
                 ...
                 {
                      echo ' <a href="dourousse_djoumoua.php?page='.$i.'">'.$i.'</a> ';
                 }
            }
            echo '</p>';
    ?>
