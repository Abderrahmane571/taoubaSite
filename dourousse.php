...
$sql2="SELECT COUNT(*) AS total from cour c where c.type_sujet='$type_sujet' and c.type='3' order by c.date_cour desc"; //Nous récupérons le contenu de la requête dans $retour_total
...
$sql3="SELECT * from cour c,cour_prof l,professeur p where c.id_cour=l.id_cour_r and p.id_prof=l.id_prof_r and c.type_sujet='$type_sujet' and c.type='3' order by c.date_cour desc LIMIT $premiereEntree,$messagesParPage"; //Nous récupérons le contenu de la requête dans $retour_total
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
            ...
            <div class="container-fluid" >
                ...
                <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="" style="border-top:none;"><a href="daouarat">دورات علمية<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-chevron-left"></span></a></li>
    ...
    <?php    
            ...
            for($i=1; $i<=$nombreDePages; $i++) //On fait notre boucle
            {
                 ...
                 {
                      echo ' <a href="dourousse.php?t='.$type_sujet.'&page='.$i.'">'.$i.'</a> ';
                 }
            }
            echo '</p>';
    ?>
